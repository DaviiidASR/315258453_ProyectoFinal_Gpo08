...
int main( )
{
    ...
    GLFWwindow *window = glfwCreateWindow( WIDTH, HEIGHT, "ProyFinalv7", nullptr, nullptr );
    ...
    Model YAdelante((char*)"Models/Patineta/.obj");
    Model YAtras((char*)"Models/Patineta/.obj");
    Model YCuerpo((char*)"Models/Patineta/.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //Patineta para animación compleja
